...
Read [ROLE_QUICK_REFERENCE.md](ROLE_QUICK_REFERENCE.md) for examples and common queries.

### Option 2: Complete Guide
Read [ROLE_AWARE_GENERATION.md](ROLE_AWARE_GENERATION.md) for detailed documentation.
...
- Quick answers: [ROLE_QUICK_REFERENCE.md](ROLE_QUICK_REFERENCE.md)
- Detailed guide: [ROLE_AWARE_GENERATION.md](ROLE_AWARE_GENERATION.md)
