...
from config import JAVA_PROBLEMS_DIR
...
def test_generator_initialization():
    ...
    assert generator.generated_problems_dir.exists(), "Generated problems directory should exist"
...
def run_all_tests():
    ...
    try:
        ...
        print("4. Check generated_problems/ for output files")
