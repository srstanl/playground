...
> test
  File: generated_problems/problem_001/solution.py
  Language: python
...
### For Quick Start
- **TEST_QUICK_START.md** - 30-second guide + examples

### For Complete Reference
- **TEST_EXECUTION.md** - Full documentation
- **PROBLEM_GENERATION.md** - Generating problems
- **FEEDBACK_SYSTEM.md** - Learning & improvement
- **README.md** - Overview
...
./generated_problems/solution.py
```
...
- Full reference: [TEST_EXECUTION.md](TEST_EXECUTION.md)
