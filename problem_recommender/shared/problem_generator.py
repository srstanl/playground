...
class ProblemGenerator:
    def __init__(self):
        self.generated_questions_dir = GENERATED_QUESTIONS_DIR
        ...
        if openai_client and openai_key:
            ...
            self.client = openai_client(api_key=openai_key)
        elif openai_client and GITHUB_TOKEN:
...
{{
    ...
    def _save_problem_file(self, problem_data: Dict[str, Any], language: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            language_dir_name = self.language_directory_names.get(language, language)
            output_dir = self.generated_questions_dir / language_dir_name
    ...
    def list_generated_questions(self) -> List[Dict[str, Any]]:
        """List all generated problems"""
        generated = []
        
        for json_file in self.generated_questions_dir.rglob("*.json"):
            try:
