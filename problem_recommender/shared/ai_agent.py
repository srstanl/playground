...
from shared.config import GITHUB_TOKEN, MODEL_ENDPOINT, MODEL_NAME
from shared.rules_engine import RulesEngine


class AIAgent:
    def __init__(self, problems: List[Dict[str, Any]], rules_engine: Optional[RulesEngine] = None, feedback_engine: Optional[Any] = None):
    ...
    def get_recommendations(
        self,
        user_query: str,
        user_progress: Optional[Dict[str, Dict[str, Any]]] = None,
        max_results: int = 5,
    ) -> List[Dict[str, Any]]:
        """
...
"""
        ...
        try:
            ...
            recommendations_text = message_content.strip()
    ...
    def _find_problem_by_name(self, name: str) -> Optional[Dict[str, Any]]:
