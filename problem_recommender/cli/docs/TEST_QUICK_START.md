...
Difficulty: easy
✨ Problem Generated!
📁 Saved to: generated_questions/<language>/problem_001_palindrome/problem_001_palindrome.py
```
...
```python
# generated_questions/<language>/problem_001_palindrome/problem_001_palindrome.py
...
Enter path to your solution file: generated_questions/<language>/problem_001_palindrome/problem_001_palindrome.py
Programming language: python
Problem name: palindrome checker
...
> test
Enter path: generated_questions/<language>/problem_003_sorting/solution.py
Language: python
...
- Or relative: `./generated_questions/<language>/solution.py`
...
1. **Generate your first problem**: `python3 cli/main.py > generate`
...
**Ready to test?** Run `python3 cli/main.py` and type `test`! 🧪
