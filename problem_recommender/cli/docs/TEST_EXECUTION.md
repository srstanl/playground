...
Enter path to your solution file: ./generated_questions/<language>/Check_Palindrome/check_palindrome.py
...
./generated_questions/<language>/problem_001/solution.py
...
```
1. Copy problem to generated_questions/<language>/
...
**Ready to test your solutions?** Run `python3 cli/main.py` and type `test`! 🚀
