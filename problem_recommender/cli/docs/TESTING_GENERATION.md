...
- File is created in `generated_questions/<language>/`
...
- File saved to `generated_questions/<language>/problem_XXX_fibonacci_java/`

## Test 3: Command-Line Generation

```bash
python3 cli/main.py --generate "linked list implementation with insert and delete in C#"
```
...
📁 File: generated_questions/<language>/problem_XXX_linked_list_csharp/problem_XXX_linked_list_csharp.cs
```
...
### Files not created
- Verify `generated_questions/<language>/` directory exists
- Check file permissions: `ls -la generated_questions/<language>/`
