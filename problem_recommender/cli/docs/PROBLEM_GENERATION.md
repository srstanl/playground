...
python3 cli/main.py --generate "merge sort implementation in Python"
...
### Files not saving
- Ensure `generated_questions/<language>/` directory has write permissions
- Check available disk space
- Verify the application has write access to the directory

### Generated problems don't appear in list
- Run `python3 cli/main.py --list-generated` to verify location
- Check `generated_questions/<language>/` directory manually
...
GENERATED_PROBLEMS_DIR = "generated_questions"
...
```
python3 cli/main.py --generate "quicksort algorithm with random pivot selection in Java"
...
**Need help?** Check `cli/docs/QUICK_START.md` or `README.md` for additional guidance!
