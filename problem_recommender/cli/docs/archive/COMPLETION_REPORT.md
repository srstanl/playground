...
| File | Size | Purpose |
|------|------|---------|
| **cli/docs/ROLE_QUICK_REFERENCE.md** | 3KB | Quick lookup tables and examples |
| **cli/docs/ROLE_VISUAL_GUIDE.md** | 8KB | Visual diagrams and workflows |

### Comprehensive Guides
| File | Size | Purpose |
|------|------|---------|
| **cli/docs/ROLE_AWARE_GENERATION.md** | 9KB | Complete feature guide (380+ lines) |
...
### For Quick Reference
→ Read: **cli/docs/ROLE_QUICK_REFERENCE.md** (3 min read)

### For Complete Guide
→ Read: **cli/docs/ROLE_AWARE_GENERATION.md** (15 min read)
...
- **Quick Examples**: cli/docs/ROLE_QUICK_REFERENCE.md
- **Complete Guide**: cli/docs/ROLE_AWARE_GENERATION.md
- **Visual Guide**: cli/docs/ROLE_VISUAL_GUIDE.md
