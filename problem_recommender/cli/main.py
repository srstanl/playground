...
from shared.test_executor import TestExecutor
...
class ProblemRecommender:
    def __init__(self):
        ...
        self.problems = self.recommendation_service.problems
        console.print(f"✓ Found {len(self.problems)} problems\n")
        
        if self.recommendation_service.initialization_error:
            console.print(f"[red]AI agent disabled: {self.recommendation_service.initialization_error}[/red]")
            console.print("[yellow]Falling back to rules engine only.[/yellow]\n")
        elif self.recommendation_service.has_ai_client:
...
"""
    ...
    def rescan_problems(self):
        ...
        self.problems = self.recommendation_service.refresh_corpus()
    ...
    def show_generated_questions(self):
        ...
        generated = self.generator.list_generated_questions()
...
def main():
    ...
    if args.generate:
        ...
        recommender.show_generated_questions()
    elif args.query:
