...
class JobScoutCliTests(unittest.TestCase):
    ...
    def test_ingest_list_and_show(self) -> None:
        ...
        self.assertIn('external_ids: {}', show_output.getvalue())
    ...
    def test_ingest_batch_jsonl(self) -> None:
        ...
        batch_file.write_text(
            "\n".join(
                [
                    '{"source_system":"linkedin","title":"Platform Engineer","company":"Example Co","external_ids":{"linkedin":"li-001","greenhouse":"gh-001"},"raw_description":"Platform JD text"}',
                    '{"source_system":"indeed","title":"Senior DevOps Engineer","unknown_field":"ignored","external_id":"id-002","raw_description":"DevOps JD text"}',
                    '{"source_system":"linkedin","title":"Broken Posting"}',
                    '{"title":"Missing Source System","raw_description":"No source system"}',
                ]
            ),
            encoding="utf-8",
        )
        ...
        self.assertIn("line 4: error: source_system is required", batch_output.getvalue())
        self.assertIn("summary: processed=4 ingested=2 failed=2 warnings=1", batch_output.getvalue())
        self.assertEqual(list_exit, 0)
    ...
    def test_track_init_rejects_duplicate_record(self) -> None:
        ...
        try:
            with redirect_stdout(StringIO()):
                cli.run(["ingest", "--file", str(job_file), "--source-system", "linkedin", "--title", "Platform Engineer"])
